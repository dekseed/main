    ...
    <section class="blog" id="blog">
      <div class="container">
        ...
        <div class="tittle tittle-2">
          ...
          <hr>
          <p>กิจกรรมของหน่วย กิจกรรมนอกหน่วย</br>หน่วยทหารแพทย์เคลื่อนที่และออกเยี่ยมบ้านพื้นที่รับผิดชอบ</p>
        </div>
        ...
        <ul class="row">
          ...
          <li class="col-md-4">
            <!-- Post Image -->
            <div class="post-img up"> <img class="img-responsive" src="{{ asset('images/pic/S_7109367401063.jpg') }}" alt="" > </div>
            <!-- Post Text Sec -->
            <div class="col-md-12 text-section text-center"> <a href="#.">เยี่ยมครอบครัว, บุตร ของกำลังพลที่มีความต้องการพิเศษ</a> <span>โพสต์โดย <strong>Admin</strong> เมื่อวันที่ <strong> 8 ธันวาคม 60</strong></span>
              <hr>
          ...
          <li class="col-md-4">
            ...
            <!-- Post Text Sec -->
            <div class="col-md-12 text-section text-center"> <a href="#.">จัด #ชุดออกหน่วยแพทย์เคลื่อนที่ ร่วมในพิธีกระทำสัตย์ปฏิญาณตนและสวนสนามนักศึกษาวิชาทหาร มณฑลทหารบกที่ ๒๙ </a> <span>โพสต์โดย <strong>Admin</strong> เมื่อวันที่ <strong> 8 ธันวาคม 60</strong></span>
              <hr>
            ...
            <!-- Post Image -->
            <div class="post-img down"> <img class="img-responsive" src="{{ asset('images/pic/DSC_6151.JPG') }}" alt="" > </div>
          </li>

          <!-- Blog Post 2 -->
          <li class="col-md-4">
            <!-- Post Image -->
            <div class="post-img up"> <img class="img-responsive" src="{{ asset('images/pic/DSC_5902.JPG') }}" alt="" > </div>
            <!-- Post Text Sec -->
            <div class="text-section text-center"> <a href="#.">จัด #ชุดออกหน่วยแพทย์เคลื่อนที่ ร่วมในพิธีมอบบ้านใน "โครงการบ้านท้องถิ่น ประชารัฐร่วมใจ เทิดไท้องค์ราชัน ราชินี"</a> <span>โพสต์โดย <strong>Admin</strong> เมื่อวันที่ <strong> 8 ธันวาคม 60</strong></span>
              <hr>
        ...
        <ul class="row">
          ...
          <li class="col-md-4">
            <!-- Post Image -->
            <div class="post-img up"> <img class="img-responsive" src="{{ asset('images/pic/05122560/DSC_4978.JPG') }}" alt="" > </div>
            <!-- Post Text Sec -->
            <div class="col-md-12 text-section text-center"> <a href="#.">ชุดแพทย์เดินเท้า กิจกรรม<br />"ความสุขจากพ่อสู่ ผืนแผ่นดิน"</a> <span>โพสต์โดย <strong>Admin</strong> เมื่อวันที่ <strong> 5 ธันวาคม 60</strong></span>
              <hr>
          ...
          <li class="col-md-4">
            <!-- Post Text Sec -->
            <div class="text-section text-center"> <a href="#.">ต้อนรับการตรวจเยี่ยมและนิเทศโรคลมร้อน</a> <span>โพสต์โดย <strong>Admin</strong> เมื่อวันที่ <strong> 30 พฤศจิกายน 60</strong></span>
              <hr>
              <p>โรงพยาบาลค่ายกฤษณ์สีวะรา ต้อนรับการตรวจเยี่ยมและนิเทศโรคลมร้อน ของ พล.ต.ธนา สุรารักษ์ แพทย์ใหญ่ ทภ.2 พร้อมด้วยคณะ</p>
            </div>
            <!-- Post Image -->
            <div class="post-img down"> <img class="img-responsive" src="{{ asset('images/pic/30112560.jpg') }}" alt="" > </div>
          </li>

          <!-- Blog Post 4 -->
          <li class="col-md-4">
            <!-- Post Image -->
            <div class="post-img up"> <img class="img-responsive" src="{{ asset('images/pic/27112560.jpg') }}" alt="" > </div>
            <!-- Post Text Sec -->
            <div class="text-section text-center"> <a href="#.">#ชุดแพทย์เดินเท้า โครงการจิตอาสา" #เราทำความ ดี ด้วยหัวใจ"</a> <span>โพสต์โดย <strong>Admin</strong> เมื่อวันที่ <strong> 27 พฤศจิกายน 60</strong></span>
              <hr>
              <p>รพ.ค่ายกฤษณ์สีวะรา ได้จัด #ชุดแพทย์เดินเท้า ให้บริการทางการแพทย์แก่พี่น้องประชาชน ที่มาร่วม โครงการจิตอาสา" #เราทำความ ดี ด้วยหัวใจ" กิจกรรม KICK OFF " #ลงแขกเกี่ยวข้าว สืบสานวัฒนธรรมพื้นบ้าน" โดย #จังหวัดสกลนคร ร่วมกับ #มณฑลทหารบกที่๒๙ #อำเภอเต่างอย #องค์การบริหารส่วนตำบลบึงทวาย #ส่วนราชการและประชาชนจิตอาสา #จังหวัดสกลนคร</p>
            </div>
          </li>
          ...
          <div class="col-lg-8">
            <div class="founder-slide">
              ...
              <div class="slide"> <img class="img-responsive" src="{{ asset('images/DSC_2078.jpg') }}" alt="">
                <h4>ร้อยเอก อณุชิฏฬ์ สุขสมัย</h4>
                <p>อายุรกรรม</p>
              </div>
    ...
    <div class="overlay">
      <div class="container">
        ...
        <div class="testi">
            ...
            <div class="item">
              <p>“โรงพยาบาลค่ายกฤษณ์สีวะรา เป็นโรงพยาบาลชั้นนำ
ขนาด 60 เตียงที่มีคุณภาพ ได้มาตรฐาน
และเป็นที่เชื่อมั่นของประชาชน ”</p>
